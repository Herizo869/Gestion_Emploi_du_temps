...
function ScrollProgress() {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-[60] h-[3px] bg-white dark:bg-white/5 shadow-md dark:shadow-none">
      <div
      ...
      {SLIDES.map(({ id, label }, idx) => (
        ...
        >
          ...
          <span className={`block rounded-full transition-all duration-300 ${idx === active
            ...
            : "w-2 h-2 bg-white dark:bg-white/3 shadow-sm dark:shadow-none0 hover:bg-white/60"
            }`} />
        </button>
      ))}
    </nav>
...
export default function Landing() {
  ...
  return (
    <div className={`font-poppins relative ${isDark ? "dark" : ""}`}>
      <div className="relative min-h-screen bg-slate-50 dark:bg-[#081234] text-slate-900 dark:text-white selection:bg-emit-sky selection:text-slate-900 dark:text-white overflow-x-hidden transition-colors duration-500">
        {/* ── Global Keyframes ─────────────────────────────────────────────────── */}
        <style>{`
      ...
      `}</style>
        ...
        {/* ── Header ─────────────────────────────────────────────────────────── */}
        <header className="fixed top-[3px] left-0 right-0 z-50 flex w-full items-center justify-between px-6 py-4 md:px-12 border-b border-slate-200 dark:border-white/5 bg-white/80 dark:bg-[#081234]/60 backdrop-blur-xl">
          <div className="flex items-center gap-3">
            <Logo />
          </div>
          <div className="flex items-center gap-3">
            <Link to="/edt" className="rounded-lg px-4 py-2 text-sm font-medium text-emit-sky hover:text-slate-900 dark:text-white hover:bg-white dark:bg-white/5 shadow-md dark:shadow-none transition-all">
              EDT Public
            </Link>
            <Button
              id="nav-login-btn"
        ...
        <Section id="slide-hero" className="flex min-h-screen flex-col items-center justify-center px-6 pt-24 pb-12 md:px-12 max-w-7xl mx-auto w-full">
          <div className="text-center space-y-7 max-w-4xl">
            ...
            <Animated variant="fade-up" delay={300}>
              <p className="text-base text-slate-600 dark:text-slate-300 md:text-xl leading-relaxed max-w-2xl mx-auto">
            ...
            <Animated variant="fade-up" delay={450}>
              <div className="flex flex-wrap items-center justify-center gap-4 pt-2">
                <Button
                  ...
                  className="bg-white hover:bg-emit-sky hover:text-white dark:hover:text-emit-navy transition-all duration-300 px-8 py-3.5 shadow-lg hover:-translate-y-1"
                >
                  Se connecter
                </Button>
                <Button
                  ...
                  className="border-white/20 text-slate-900 dark:text-white hover:bg-white dark:bg-white/5 shadow-md dark:shadow-none hover:border-emit-sky/40 transition-all duration-300 px-6 hover:-translate-y-1"
                >
            ...
            <Animated variant="fade-up" delay={600}>
              <div className="mt-10 grid grid-cols-3 gap-6 border-t border-slate-200 dark:border-white/5 pt-10 max-w-lg mx-auto">
                <div className="text-center">
                  <p className="text-2xl font-extrabold text-emit-sky"><Counter end={7} /> slides</p>
                  <p className="text-[11px] text-slate-400 dark:text-slate-500 dark:text-slate-400 mt-0.5">Présentation complète</p>
                </div>
                <div className="text-center">
                  <p className="text-2xl font-extrabold text-indigo-300"><Counter end={3} /> rôles</p>
                  <p className="text-[11px] text-slate-400 dark:text-slate-500 dark:text-slate-400 mt-0.5">Admin · Ens. · Public</p>
                </div>
                <div className="text-center">
                  <p className="text-2xl font-extrabold text-emerald-400">100<span className="text-lg">%</span></p>
                  <p className="text-[11px] text-slate-400 dark:text-slate-500 dark:text-slate-400 mt-0.5">Sans conflit horaire</p>
                </div>
              </div>
            </Animated>
          </div>
          ...
          <button
            ...
            className="absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-1.5 text-xs text-slate-400 dark:text-slate-500 dark:text-slate-400 hover:text-emit-sky transition-all animate-bounce"
          >
            <span>Découvrir</span>
        ...
        {/* ══════════════════════════════════════════════════════════════════════ */}
        <Section id="slide-problem" className="flex min-h-screen items-center justify-center px-6 py-28 md:px-12 max-w-7xl mx-auto w-full border-t border-slate-200 dark:border-white/5">
          <div className="grid lg:grid-cols-2 gap-16 items-center w-full">
              ...
              <div className="space-y-5">
                {[
                  ...
                  <Animated key={title} variant="fade-right" delay={delay}>
                    <TiltCard><div className="group flex items-start gap-4 rounded-xl p-4 border border-slate-200 dark:border-white/5 bg-white dark:bg-white/3 shadow-sm dark:shadow-none hover:bg-white dark:bg-white/5 shadow-md dark:shadow-none hover:border-red-500/20 transition-all duration-300 card-glow">
                      <span className="flex-shrink-0 transition-transform group-hover:scale-110 duration-300">{icon}</span>
                      <div>
                        <h4 className="font-bold text-slate-900 dark:text-white text-sm group-hover:text-red-400 transition-colors">{title}</h4>
                        <p className="text-xs text-slate-400 dark:text-slate-500 dark:text-slate-400 mt-0.5 leading-relaxed">{desc}</p>
                      </div>
                    </div>
                    </TiltCard>
                  </Animated>
            ...
            <Animated variant="fade-left" delay={100}>
              <div className="relative rounded-2xl border border-slate-200 dark:border-white/10 bg-gradient-to-b from-white/8 to-white/3 p-8 backdrop-blur-md shadow-2xl text-center space-y-5 card-glow transition-all duration-500 hover:border-red-400/20">
                {/* Decorative corner */}
                ...
                <h3 className="font-bold text-xl text-slate-900 dark:text-white">L'approche traditionnelle</h3>
        ...
        {/* ══════════════════════════════════════════════════════════════════════ */}
        <Section id="slide-architecture" className="flex min-h-screen items-center justify-center px-6 py-28 md:px-12 max-w-7xl mx-auto w-full border-t border-slate-200 dark:border-white/5">
            ...
            <Animated variant="zoom" delay={100}>
              <div className="flex flex-col md:flex-row items-center justify-center gap-3 md:gap-0 max-w-3xl mx-auto">
                {[
                  ...
                  item === null ? (
                    <div key={i} className="text-slate-400 dark:text-slate-500 text-lg md:mx-3">→</div>
                  ) : (
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                ...
                <Animated key={title} variant="fade-up" delay={delay}>
                  <div className={`group h-full rounded-2xl bg-white/4 border border-slate-200 dark:border-white/10 p-6 backdrop-blur-md transition-all duration-300 hover:-translate-y-2 hover:shadow-lg card-glow text-left space-y-4 ${colorClass}`}>
                    ...
                    <div>
                      <h3 className="font-bold text-lg text-slate-900 dark:text-white group-hover:text-current transition-colors">{title}</h3>
                      <p className="text-xs text-slate-400 dark:text-slate-500 dark:text-slate-400 mt-1">{desc}</p>
                    </div>
        ...
        {/* ══════════════════════════════════════════════════════════════════════ */}
        <Section id="slide-features" className="flex min-h-screen items-center justify-center px-6 py-28 md:px-12 max-w-7xl mx-auto w-full border-t border-slate-200 dark:border-white/5">
              ...
              <Animated variant="fade-right" delay={100}>
                <ul className="space-y-3.5">
                  {[
                    ...
                    <li key={i} className="group flex items-center gap-3 text-sm text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:text-white transition-colors cursor-default">
            ...
            <div className="lg:col-span-7 grid sm:grid-cols-2 gap-4">
              {[
                ...
                <Animated key={title} variant="zoom" delay={delay}>
                  <TiltCard className="h-full"><div className={`h-full group rounded-xl border border-slate-200 dark:border-white/10 bg-white/4 p-5 space-y-2 transition-all duration-300 ${color} hover:bg-white/8 hover:-translate-y-1 card-glow`}>
                    <div className="transition-transform group-hover:scale-125 duration-300">{icon}</div>
                    <h4 className="font-bold text-slate-900 dark:text-white text-sm group-hover:text-emit-sky transition-colors">{title}</h4>
                    <p className="text-xs text-slate-400 dark:text-slate-500 dark:text-slate-400 leading-relaxed">{desc}</p>
                  </div>
                  </TiltCard>
                </Animated>
              ))}
        ...
        {/* SLIDE 5 — SÉCURITÉ                                                    */}
        {/* ══════════════════════════════════════════════════════════════════════ */}
        <Section id="slide-security" className="flex min-h-screen items-center justify-center px-6 py-28 md:px-12 max-w-7xl mx-auto w-full border-t border-slate-200 dark:border-white/5">
          <div className="grid lg:grid-cols-2 gap-14 items-center w-full">
            <Animated variant="fade-left">
              <div className="relative rounded-2xl border border-emerald-500/25 bg-emerald-500/5 p-8 shadow-2xl space-y-6 transition-all duration-500 hover:border-emerald-500/40 card-glow overflow-hidden">
                ...
                <h3 className="text-xl font-bold text-slate-900 dark:text-white">Sécurité Multi-Couche</h3>
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <TiltCard key={title}><div className="group flex items-start gap-3 rounded-lg bg-white dark:bg-white/3 shadow-sm dark:shadow-none border border-slate-200 dark:border-white/5 px-3 py-2.5 hover:bg-emerald-500/5 hover:border-emerald-500/15 transition-all">
                      <span className="flex-shrink-0 pt-0.5">{icon}</span>
                      <div>
                        <p className="text-xs font-bold text-slate-900 dark:text-white group-hover:text-emerald-400 transition-colors">{title}</p>
                        <p className="text-[11px] text-slate-400 dark:text-slate-500 dark:text-slate-400 mt-0.5">{desc}</p>
                      </div>
                    </div>
                    </TiltCard>
                  ))}
              ...
              <div className="space-y-4">
                <Animated variant="fade-right" delay={100}>
                  <div className="group rounded-xl border border-emit-sky/20 bg-emit-sky/5 p-5 hover:border-emit-sky/40 transition-all card-glow">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <h4 className="font-bold text-slate-900 dark:text-white group-hover:text-emit-sky transition-colors">Administrateur</h4>
                    </div>
                    <p className="text-xs text-slate-400 dark:text-slate-500 dark:text-slate-400 leading-relaxed">Contrôle complet : gestion des enseignants, salles, semestres, déclenchement de la génération d'emploi du temps, résolution des conflits et journal d'audit.</p>
                  </div>
                </Animated>
                <Animated variant="fade-right" delay={200}>
                  <div className="group rounded-xl border border-slate-200 dark:border-white/10 bg-white/4 p-5 hover:border-white/20 transition-all card-glow">
                    <div className="flex items-center gap-3 mb-2">
                      <div className="flex h-8 w-8 items-center justify-center rounded-full bg-white dark:bg-white/5 shadow-md dark:shadow-none border border-slate-200 dark:border-white/10 text-slate-600 dark:text-slate-300 font-extrabold text-sm">E</div>
                      <h4 className="font-bold text-slate-900 dark:text-white">Enseignant</h4>
                    </div>
                    <p className="text-xs text-slate-400 dark:text-slate-500 dark:text-slate-400 leading-relaxed">Consultation de ses cours assignés, son planning individuel, édition de ses disponibilités hebdomadaires, téléchargement de son emploi du temps personnel.</p>
                  </div>
                </Animated>
                <Animated variant="fade-right" delay={300}>
                  <div className="group rounded-xl border border-slate-700/40 bg-white/2 p-5 hover:border-slate-500/40 transition-all">
                    <div className="flex items-center gap-3 mb-2">
                      <div className="flex h-8 w-8 items-center justify-center rounded-full bg-white dark:bg-white/3 shadow-sm dark:shadow-none border border-white/8 text-slate-400 dark:text-slate-500 font-extrabold text-sm">P</div>
                      <h4 className="font-bold text-slate-600 dark:text-slate-300">Public (Étudiant)</h4>
                    </div>
                    <p className="text-xs text-slate-400 dark:text-slate-500 leading-relaxed">Accès sans compte requis à la grille d'emploi du temps publique, filtrable par niveau, filière et semestre. Téléchargement PDF disponible.</p>
                  </div>
                </Animated>
              </div>
            </div>
        ...
        {/* ══════════════════════════════════════════════════════════════════════ */}
        <Section id="slide-demo" className="flex min-h-screen items-center justify-center px-6 py-28 md:px-12 max-w-7xl mx-auto w-full border-t border-slate-200 dark:border-white/5">
          <div className="space-y-10 w-full">
            ...
            <Animated variant="zoom" delay={100}>
              <div className="max-w-5xl mx-auto rounded-2xl border border-slate-200 dark:border-white/10 bg-white/4 overflow-hidden shadow-2xl backdrop-blur-md transition-all hover:border-emit-sky/20">
                {/* Fake browser chrome */}
                <div className="flex items-center gap-2 bg-white dark:bg-white/5 shadow-md dark:shadow-none border-b border-white/8 px-4 py-3">
                  <div className="flex gap-1.5">
                    <span className="h-3 w-3 rounded-full bg-red-400/70" />
                    <span className="h-3 w-3 rounded-full bg-yellow-400/70" />
                    <span className="h-3 w-3 rounded-full bg-green-400/70" />
                  </div>
                  <div className="flex-1 mx-4 rounded-md bg-white dark:bg-white/5 shadow-md dark:shadow-none border border-white/8 px-3 py-1 text-[10px] text-slate-400 dark:text-slate-500 dark:text-slate-400">
                ...
                <div className="p-5 space-y-4">
                  <div className="flex items-center justify-between text-xs border-b border-white/8 pb-3">
                    ...
                    <div className="flex gap-3">
                      <span className="flex items-center gap-1.5 text-slate-400 dark:text-slate-500 dark:text-slate-400"><span className="h-2 w-2 rounded-full bg-emit-navy animate-pulse" /> CM</span>
                      <span className="flex items-center gap-1.5 text-slate-400 dark:text-slate-500 dark:text-slate-400"><span className="h-2 w-2 rounded-full bg-emit-sky animate-pulse" /> TD</span>
                      <span className="flex items-center gap-1.5 text-slate-400 dark:text-slate-500 dark:text-slate-400"><span className="h-2 w-2 rounded-full bg-green-500 animate-pulse" /> TP</span>
                    </div>
                  </div>
                  ...
                  <div className="overflow-x-auto">
                    <table className="w-full text-xs text-center">
                      <thead>
                        <tr className="text-slate-400 dark:text-slate-500 dark:text-slate-400 text-[10px]">
                          <th className="pb-2 w-20 text-left text-slate-400 dark:text-slate-500">Horaire</th>
                      ...
                      <tbody className="space-y-2">
                        {[
                          {
                            time: "07h30", cells: [
                              { label: "Algorithmique", sub: "L1 · AMPHI-1", cls: "bg-white dark:bg-white/5 shadow-md dark:shadow-none border-white/8" },
                              { label: "—", sub: "", cls: "bg-transparent border-transparent text-slate-600" },
                              { label: "Réseaux", sub: "L3 · AMPHI-2", cls: "bg-white dark:bg-white/5 shadow-md dark:shadow-none border-white/8" },
                              { label: "—", sub: "", cls: "bg-transparent border-transparent text-slate-600" },
                              { label: "Maths", sub: "L1 · A102", cls: "bg-white dark:bg-white/5 shadow-md dark:shadow-none border-white/8" },
                            ]
                          },
                          {
                            time: "09h15", cells: [
                          ...
                          {
                            time: "13h30", cells: [
                              { label: "Bases de Données", sub: "L2 · AMPHI-1", cls: "bg-white dark:bg-white/5 shadow-md dark:shadow-none border-white/8" },
                              { label: "—", sub: "", cls: "bg-transparent border-transparent text-slate-600" },
                              { label: "BDD SQL TP", sub: "L2 · B201", cls: "bg-green-500/20 border-green-500/20 text-green-400" },
                              { label: "—", sub: "", cls: "bg-transparent border-transparent text-slate-600" },
                              { label: "DevOps", sub: "M1 · AMPHI-2", cls: "bg-white dark:bg-white/5 shadow-md dark:shadow-none border-white/8" },
                            ]
                          },
                        ].map(({ time, cells }) => (
                          <tr key={time}>
                            <td className="py-1.5 text-left text-[10px] text-slate-400 dark:text-slate-500">{time}</td>
                            {cells.map((cell, ci) => (
                              <td key={ci} className="py-1 px-1">
                                {cell.label !== "—" ? (
                                  <div className={`rounded-lg border px-1 py-2 transition-all hover:scale-105 cursor-pointer ${cell.cls}`}>
                                    <p className="font-bold text-slate-900 dark:text-white text-[10px] leading-tight">{cell.label}</p>
        ...
        {/* SLIDE 7 — CONCLUSION                                                   */}
        {/* ══════════════════════════════════════════════════════════════════════ */}
        <Section id="slide-conclusion" className="flex min-h-screen items-center justify-center px-6 py-28 md:px-12 max-w-7xl mx-auto w-full border-t border-slate-200 dark:border-white/5">
          <div className="text-center space-y-8 max-w-2xl">
            ...
            <Animated variant="fade-up" delay={200}>
              <div className="flex flex-wrap items-center justify-center gap-4 pt-2">
                <Button
                  ...
                  onClick={() => navigate("/login")}
                  rightIcon={<ArrowRight className="h-4 w-4" />}
                  className="bg-white hover:bg-emit-sky hover:text-white dark:hover:text-emit-navy transition-all duration-300 px-8 py-3.5 hover:-translate-y-1"
                >
            ...
            <Animated variant="fade-up" delay={350}>
              <div className="mt-6 grid grid-cols-3 gap-6 border-t border-slate-200 dark:border-white/5 pt-8 max-w-md mx-auto">
                <div className="text-center">
                  <p className="text-xl font-extrabold text-emit-sky"><Counter end={12} />+</p>
                  <p className="text-[10px] text-slate-400 dark:text-slate-500 mt-0.5">Entités gérées</p>
                </div>
                <div className="text-center">
                  <p className="text-xl font-extrabold text-violet-300"><Counter end={5} /> niveaux</p>
                  <p className="text-[10px] text-slate-400 dark:text-slate-500 mt-0.5">L1 → M2</p>
                </div>
                <div className="text-center">
                  <p className="text-xl font-extrabold text-emerald-400">∞ semestres</p>
                  <p className="text-[10px] text-slate-400 dark:text-slate-500 mt-0.5">Illimité</p>
                </div>
              </div>
            </Animated>
        ...
        {/* ── Footer navigation ───────────────────────────────────────────────── */}
        <footer className="relative z-10 flex flex-wrap items-center justify-between gap-4 px-6 py-6 border-t border-slate-200 dark:border-white/5 bg-slate-100/80 dark:bg-[#081234]/40 text-xs text-slate-400 dark:text-slate-500">
